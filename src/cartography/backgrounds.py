    ...
    def __get_dictionary(self):
        ...
        dictionary = [
            {'tiles': 'https://tile.viaeuropa.uk.com/' +  e_technologies + '/m0306/{z}/{x}/{y}.png',
             ...
             'filename': 'vml-spm-ordnance-survey', 'zoom_start': 8, 'min_zoom': 8, 'max_zoom': 17, 'crs': 'EPSG3857'},
            {'tiles': 'https://tile.viaeuropa.uk.com/' +  e_technologies + '/m0310/{z}/{x}/{y}.png',
             'attr': '© Europa Technologies Ltd. Contains Ordnance Survey data © Crown copyright and database',
             'filename': 'mm-spm-ordnance-survey', 'zoom_start': 8, 'min_zoom': 8, 'max_zoom': 17, 'crs': 'EPSG3857'},
            {'tiles': 'https://tile.viaeuropa.uk.com/' +  e_technologies + '/m0206/{z}/{x}/{y}.png',
             'attr': '© Europa Technologies Ltd. Contains Ordnance Survey data © Crown copyright and database',
             'filename': 'vml-bng2-ordnance-survey', 'zoom_start': 8, 'min_zoom': 8, 'max_zoom': 17, 'crs': 'EPSG27700'},
            {'tiles': 'OpenStreetMap',
             'attr': None,
